<?php
    class Destino {
        ...
        public static function obtenerDestinosOrdenados(){
            $objAccesoDatos = AccesoDatos::obtenerInstancia();
            $consulta = $objAccesoDatos->prepararConsulta("SELECT d.idDestino, d.nombre, d.provincia, COUNT(m.destino) AS cantidadDeMensajes FROM destino AS d, mensaje AS m GROUP BY m.destino ORDER BY cantidadDeMensajes");
            $consulta->execute();
